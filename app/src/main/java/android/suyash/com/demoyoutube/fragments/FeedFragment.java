...
import android.suyash.com.demoyoutube.adapter.FeedListAdapter;
import android.suyash.com.demoyoutube.model.Feed;
import android.suyash.com.demoyoutube.utis.Constants;
...
public class FeedFragment extends BaseFragment {
    ...
    private class DummyFeedLoader extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                Thread.sleep(500);
                items = Constants.getRandomFeed(getActivity());
                status = "success";
            } catch (Exception e) {
                status = "failed";
            }
