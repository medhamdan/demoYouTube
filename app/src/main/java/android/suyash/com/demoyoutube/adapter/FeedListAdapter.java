...
import android.suyash.com.demoyoutube.dialog.CommentDialog;
import android.suyash.com.demoyoutube.model.Feed;
import android.suyash.com.demoyoutube.views.CircleTransform;
...
public class FeedListAdapter extends RecyclerView.Adapter<FeedListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.bt_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                CommentDialog commentDialog = new CommentDialog(ctx);
                commentDialog.show();
